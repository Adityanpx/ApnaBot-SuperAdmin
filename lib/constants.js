...
export const API = {
  ...
  SHOP_GRANT_SUBSCRIPTION:    (id) => `/api/admin/shops/${id}/grant-subscription`,
  SHOP_SUBSCRIPTION_HISTORY:  (id) => `/api/admin/shops/${id}/subscription-history`,
...
// BUSINESS_TYPES stays as-is for shops/templates.
...
export const NAV_ITEMS = [
  ...
  { href: '/shops',            label: 'Business',        icon: 'Store' },
  { href: '/plans',            label: 'Plans',           icon: 'CreditCard' },
  { href: '/templates',        label: 'Templates',       icon: 'FileText' },
  { href: '/flow-packs',       label: 'Flow Packs',      icon: 'Workflow' },
